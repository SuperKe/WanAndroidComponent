...
import com.demo.chenke.logincomponent.contact.LoginUiContact;
...
public class LoginPresenter extends BasePresenterImpl<LoginDataContact.view> implements LoginDataContact.presenter {
    private LoginUiContact loginView;

    public LoginPresenter(LoginDataContact.view view, LoginUiContact loginView) {
        super(view);
